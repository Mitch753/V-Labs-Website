				...
				menu: [{
					...
					onclick: function(){
						ed.windowManager.open({
							...
							body: [{
								...
								id : 'button-class',
								values : [
									{ value: 'primary', text: 'Normaal' },
									{ value: 'secondary', text: 'Secondary' },
									{ value: 'tertiary', text: 'Tertiary' },
									{ value: 'outline', text: 'Outline' },
									{ value: 'textlink', text: 'Textlink' },
								],
								value : ''
							}],
							onsubmit: function(e){
					...
					onclick: function(){
						ed.windowManager.open({
							...
							onsubmit: function(e){
								ed.insertContent('[accordion title="' + e.data.title + '"]' + e.data.text.replaceAll('\n', '<br/>') + '[/accordion]');
							}
						});
					}
				},{
					...
					onclick: function(){
						ed.windowManager.open({
							...
							onsubmit: function(e){
								ed.insertContent('[tooltip title="' + e.data.title + '"]' + e.data.text.replaceAll('\n', '<br/>') + '[/tooltip]');
							}
						});
					}
				},{
